...
// Récupérer les conversations avec les donateurs
$query = "
    SELECT DISTINCT 
...
<body>
    ...
    <div class="container">
        <div class="dashboard-header">
            <h1>💬 Messagerie</h1>
            <p>Communiquez avec les donateurs</p>
        </div>
                ...
                <div class="card-body" style="padding: 0;">
                    <?php if(empty($conversations)): ?>
                        <div style="text-align: center; padding: 2rem; color: #666;">
                            ...
                            <small>Les conversations apparaîtront quand vous ferez des demandes</small>
                        </div>
                    <?php else: ?>
            ...
            <div class="chat-messages card">
                    ...
                    <div class="chat-header">
                        <div style="display: flex; align-items: center; gap: 1rem;">
                            ...
                            <div>
                                ...
                                <br>
                                <small style="color: #666;">Donateur</small>
                            </div>
                        </div>
                    </div>
                ...
                <?php else: ?>
                    <div class="empty-chat">
                        ...
                        <p>Communiquez avec les donateurs pour organiser les retraits</p>
                    </div>
                <?php endif; ?>
            </div>
        </div>
